    ...
    <div className="relative max-w-lg mx-auto bg-card/95 backdrop-blur-md p-10 md:p-14 rounded-lg shadow-xl text-center">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
        ...
        <a
          ...
          className="inline-flex items-center gap-2 border border-primary-foreground/40 text-primary-foreground px-8 py-4 font-body text-sm uppercase tracking-widest hover:bg-primary-foreground/10 transition-colors"
        >
